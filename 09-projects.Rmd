...
```
    1. Create Figure 1 in your report, which should display the map shown by [https://www.opportunityatlas.org](https://www.opportunityatlas.org) for the census tracts around your home (you can download that map *as an image* bottom left).
```{r include = showsols, out.width = "75%"}
include_graphics("images/pv-atlas.png")
```
...
```{r include = showsols, out.width = "75%"}
include_graphics("images/pv-atlas-2.png")
include_graphics("images/pv-atlas-3.png")
```
