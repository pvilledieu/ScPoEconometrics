...
```{r mean1, exercise=TRUE, exercise.eval=TRUE, exercise.setup="prepare-x"}
...
```{r unique, exercise=TRUE, exercise.eval=TRUE, exercise.setup="prepare-x"}
...
```{r,echo=TRUE, exercise.setup="prepare-x"}
sort(x)
```
...
```{r var, exercise=TRUE, exercise.eval=TRUE, exercise.setup="prepare-x"}
...
```{r var2, exercise=TRUE, exercise.eval=TRUE, exercise.setup="prepare-x"}
